...
VK = {
    ...
    "printscreen": 0x2C, "insert": 0x2D, "capslock": 0x14, "menu": 0x5D,
    # Punctuation, for shortcuts like Ctrl+, (settings) and Ctrl+` (terminal)
    "comma": 0xBC, "period": 0xBE, "dot": 0xBE, "slash": 0xBF,
    "semicolon": 0xBA, "quote": 0xDE, "backtick": 0xC0, "tilde": 0xC0,
    "minus": 0xBD, "dash": 0xBD, "plus": 0xBB, "equals": 0xBB,
